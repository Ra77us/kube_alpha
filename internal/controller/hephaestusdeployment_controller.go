...
//+kubebuilder:rbac:groups=operator.kubiki,resources=hephaestusdeployments,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.kubiki,resources=hephaestusdeployments/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.kubiki,resources=hephaestusdeployments/finalizers,verbs=update
