...
//+kubebuilder:rbac:groups=alpha.kubiki,resources=tests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=alpha.kubiki,resources=tests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=alpha.kubiki,resources=tests/finalizers,verbs=update
...
func (r *FooReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Get the Tst resource that triggered the reconciliation request
	var foo alphav1.Test
