...
//+kubebuilder:rbac:groups=kubiki.kubiki.alpha,resources=testoperartors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kubiki.kubiki.alpha,resources=testoperartors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kubiki.kubiki.alpha,resources=testoperartors/finalizers,verbs=update
